...
*Open up* **MI_Chevron** and *place it* next to the chevron in the editor. Add a value to **PanSpeedX** to make it animate.  Make it a negative number to move to the *right*. I settled on `-0.25`. Now you can also animate the PanSpeedY but it doesn't work for the chevron. *Press* the <kbd>Play</kbd> button
